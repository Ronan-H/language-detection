...
public class ParserTest {
    public static void main(String[] args) {
        ...
        HashedKmer hashedKmer = new HashedKmer(Language.Unidentified, 1024);
        hashedKmer.recordLine(french, 3);
        Language closest = db.findClosestLanguage(hashedKmer);
